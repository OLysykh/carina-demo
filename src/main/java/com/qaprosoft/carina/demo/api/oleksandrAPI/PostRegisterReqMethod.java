...
public class PostRegisterReqMethod extends AbstractApiMethodV2 {

    public PostRegisterReqMethod() {
        super("api/reqres/postRegister/rq.json", "api/reqres/postRegister/rs.json");
